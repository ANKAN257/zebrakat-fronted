...
import AdminExperienceComponent from "./AdminExperienceComponent";
...
function AdminExp() {
  ...
  console.log("portfolioData  myexperiences  ::::: ", portfolioData);
  ...
  return (
    <div>
      ...
      <div>
        {portfolioData && portfolioData.myexperiences ? (
          <AdminExperienceComponent
            myexperiences={portfolioData.myexperiences}
            titleText=" Admin  Experiences section"
          />
        ) : (
